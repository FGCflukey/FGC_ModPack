...
Interactions.HNT = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_LGRHunting"), Perks.LGRHunting); end   --hunting
--end

--if SWPBaseGameCharacterDetails then
Interactions.AMR = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_AMReloading"), Perks.AMReloading); end   --Ammo Reloading
--end
