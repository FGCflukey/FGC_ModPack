...
farming_vegetableconf.getObjectName = function(plant)
	...
	elseif plant.nbOfGrow == 6 then
		if plant.typeOfSeed == "Lemon" or plant.typeOfSeed == "Orange" or plant.typeOfSeed == "Cannabis" or plant.typeOfSeed == "Apple" or plant.typeOfSeed == "Pear" or plant.typeOfSeed == "Peach" or plant.typeOfSeed == "Banana" or plant.typeOfSeed == "Cherry" or plant.typeOfSeed == "Lime" or plant.typeOfSeed == "Avocado" or plant.typeOfSeed == "GrapeFruit" or plant.typeOfSeed == "Mango" then
			return getText("Farming_Ready_for_Harvest") .. " " .. getText("Farming_" ..plant.typeOfSeed);
		else
...
farming_vegetableconf.growCannabis = function(planting, nextGrowing, updateNbOfGrow)
	local nbOfGrow = planting.nbOfGrow;
	local water = farming_vegetableconf.calcWater(planting.waterNeeded, planting.waterLvl);
	local diseaseLvl = farming_vegetableconf.calcDisease(planting.mildewLvl);
	if (nbOfGrow == 0) then -- young
...
farming_vegetableconf.props["Tobacco"].timeToGrow = ZombRand(120, 180);
...
-- Cannabis (3.5 months to grow)
farming_vegetableconf.props["Cannabis"] = {};
farming_vegetableconf.props["Cannabis"].requiredskill = 7;
farming_vegetableconf.props["Cannabis"].seedsRequired = 1;
farming_vegetableconf.props["Cannabis"].sticksRequired = 0;
farming_vegetableconf.props["Cannabis"].sheetropeRequired = 0;
farming_vegetableconf.props["Cannabis"].plantType = 1;
farming_vegetableconf.props["Cannabis"].texture = "canna_05";
farming_vegetableconf.props["Cannabis"].waterLvl = 75;
