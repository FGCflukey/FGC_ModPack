...
function SFarmingSystem:growPlant(luaObject, nextGrowing, updateNbOfGrow)
	if(luaObject.state == "seeded") then
		...
		if (luaObject.typeOfSeed == "Lemon") or 
		  (luaObject.typeOfSeed == "Orange") or
		  (luaObject.typeOfSeed == "Apple") or
		  (luaObject.typeOfSeed == "Pear") or
		  (luaObject.typeOfSeed == "Peach") or
		  (luaObject.typeOfSeed == "Banana") or
		  (luaObject.typeOfSeed == "Cherry") or
		  (luaObject.typeOfSeed == "Lime") or
		  (luaObject.typeOfSeed == "Avocado") or
		  (luaObject.typeOfSeed == "GrapeFruit")or
		  (luaObject.typeOfSeed == "Mango") then
			if (luaObject.nbOfGrow >6) then
				luaObject.nbOfGrow = 5;
			end
		end
		...
		elseif(luaObject.typeOfSeed == "Peanut") then
			luaObject = farming_vegetableconf.growPeanut(luaObject, nextGrowing, updateNbOfGrow)
		...
		elseif(luaObject.typeOfSeed == "Bean") then
			luaObject = farming_vegetableconf.growBean(luaObject, nextGrowing, updateNbOfGrow)
		...
		elseif(luaObject.typeOfSeed == "Pea") then
			luaObject = farming_vegetableconf.growPea(luaObject, nextGrowing, updateNbOfGrow)
		...
		elseif(luaObject.typeOfSeed == "Coffee") then
			luaObject = farming_vegetableconf.growCoffee(luaObject, nextGrowing, updateNbOfGrow)
		elseif(luaObject.typeOfSeed == "Chili") then
			luaObject = farming_vegetableconf.growChili(luaObject, nextGrowing, updateNbOfGrow)
		elseif(luaObject.typeOfSeed == "Jalapeno") then
			luaObject = farming_vegetableconf.growJalapeno(luaObject, nextGrowing, updateNbOfGrow)
		elseif(luaObject.typeOfSeed == "Habanero") then
			luaObject = farming_vegetableconf.growHabanero(luaObject, nextGrowing, updateNbOfGrow)
		...
		elseif(luaObject.typeOfSeed == "Tobacco") then
			luaObject = farming_vegetableconf.growTobacco(luaObject, nextGrowing, updateNbOfGrow)
		...
		elseif(luaObject.typeOfSeed == "Cannabis") then
		    luaObject = farming_vegetableconf.growCannabis(luaObject, nextGrowing, updateNbOfGrow)
		...
		--		saveData(planting)
		if luaObject.fertilizer ~= nil then
			if luaObject.fertilizer > 0 and luaObject.fertilizer < 5 then
				luaObject.fertilizer = luaObject.fertilizer - 1;
			end
		end
	end
end
...
function SFarmingSystem:harvest(luaObject, player)
	...
	local vegetable = props.vegetableName;
	local healthModifier = (luaObject.health * 0.5) /1000;
	if healthModifier < 0 then
		healthModifier = 0;
	end
	if luaObject.typeOfSeed == "Pineapple" then
		numberOfVeg = 1;
	end
	...
	if player then
		...
		if vegetable == "legourmetfarming.NaturalPineapple" or 
		  vegetable == "legourmetfarming.NaturalLemon" or 
		  vegetable == "legourmetfarming.NaturalOrange" or
		  vegetable == "legourmetfarming.NaturalApple" or
		  vegetable == "legourmetfarming.NaturalPeach" or
		  vegetable == "legourmetfarming.NaturalBanana" or
		  vegetable == "legourmetfarming.NaturalCherry" or
		  vegetable == "legourmetfarming.NaturalLime" or
		  vegetable == "legourmetfarming.NaturalAvocado" or
		  vegetable == "Base.Mango" or
		  vegetable == "Base.Grapefruit" then
			if player:getPerkLevel(Perks.Farming) < 7 then
	...
	-- the Frutal tree don't disapear, it goes on phase 5 again
	if luaObject.typeOfSeed == "Strawberry plant" then
		luaObject.nbOfGrow = 1
		self:growPlant(luaObject, nil, true)
		luaObject:saveData()
	elseif luaObject.typeOfSeed == "Lemon" or luaObject.typeOfSeed == "Orange" or luaObject.typeOfSeed == "Apple" or luaObject.typeOfSeed == "Pear" or luaObject.typeOfSeed == "Peach" or luaObject.typeOfSeed == "Banana" or luaObject.typeOfSeed == "Cherry" or luaObject.typeOfSeed == "Lime" or luaObject.typeOfSeed == "Avocado" or luaObject.typeOfSeed == "Mango" or luaObject.typeOfSeed == "GrapeFruit" then
		luaObject.nbOfGrow = 5
		self:growPlant(luaObject, nil, true)
		luaObject:saveData()
	else
