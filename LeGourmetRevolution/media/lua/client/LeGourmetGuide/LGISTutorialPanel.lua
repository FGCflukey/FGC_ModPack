...
LGISTutorialPanel = ISPanel:derive("LGISTutorialPanel");
...
function LGISTutorialPanel:initialise()
...
--**
--************************************************************************--
function LGISTutorialPanel:createChildren()
	...
	local previousButton = ISButton:new(3, (panel2.height / 2), 20, 20, "", self, LGISTutorialPanel.previousPage);
	...
	local nextButton = ISButton:new(24, (panel2.height / 2), 20, 20, "", self, LGISTutorialPanel.nextPage);
	...
	local closeButton = ISButton:new(self.width - 23, (panel2.height / 2), 20, 20, "", self, LGISTutorialPanel.closePage);
    ...
    local moreInfo = ISButton:new(closeButton:getX() - buttonWid - 1, (panel2.height / 2), buttonWid, 20, getText("IGUI_Tutorial_MoreInfo"), self, LGISTutorialPanel.moreInfo);
...
function LGISTutorialPanel:reloadBtns()
...
function LGISTutorialPanel:previousPage(button)
...
function LGISTutorialPanel:closePage(button)
...
--************************************************************************--
--** LGISTutorialPanel:nextPage
--**
--************************************************************************--
function LGISTutorialPanel:nextPage(button)
    self.tutorialSetInfo.currentPage = self.tutorialSetInfo.currentPage + 1;
    self.tutorialSetInfo:applyPageToRichTextPanel(self.richtext);
	if self.moreinfo == nil then
       self:initMoreInfoPanel();
...
function LGISTutorialPanel:initMoreInfoPanel()
...
function LGISTutorialPanel:moreInfo(button)
    if self.moreinfo == nil then
       self:initMoreInfoPanel();
    else
		if self.moreinfo:getIsVisible() then
...
--************************************************************************--
--** LGISTutorialPanel:render
--**
--************************************************************************--
function LGISTutorialPanel:prerender()
...
function LGISTutorialPanel:render()
...
--************************************************************************--
--** LGISTutorialPanel:update
--**
--************************************************************************--
function LGISTutorialPanel:update()
...
--**
--************************************************************************--
function LGISTutorialPanel:new (x, y, width, height)
	local o = {}
	--o.data = {}
