...
function SPlantGlobalObject:stateToIsoObject(isoObject)
	...
	if self.lastWaterHour and self.lastWaterHour > SFarmingSystem.instance.hoursElapsed then
		if farming_vegetableconf.props[self.typeOfSeed] then
			self.nextGrowing = farming_vegetableconf.props[self.typeOfSeed].timeToGrow
		end
...
-- if we add Aphids spray
function SPlantGlobalObject:cureAphids(aphidsCureSource, uses)
	for i=1,uses do
...
function SPlantGlobalObject:dryThis()
	if self.typeOfSeed == "Tomato" or self.typeOfSeed == "Chili" or self.typeOfSeed == "Habanero" or self.typeOfSeed == "Jalapeno" then
		self:setSpriteName("vegetation_farming_01_6")
	elseif self.typeOfSeed == "Leek" then
		self:setSpriteName("LegourmetFarming_02_15")
	elseif self.typeOfSeed == "Lettuce" then
		self:setSpriteName("LegourmetFarming_02_23")
	elseif self.typeOfSeed == "Onion" then
		self:setSpriteName("LegourmetFarming_02_7")
	elseif self.typeOfSeed == "Peanut" then
		self:setSpriteName("LegourmetFarming_02_31")
	elseif self.typeOfSeed == "Pumpkin" then
		self:setSpriteName("LegourmetFarming_02_40")
	elseif self.typeOfSeed == "Watermelon" then
		self:setSpriteName("LegourmetFarming_02_40")
	elseif self.typeOfSeed == "Zucchini" then
		self:setSpriteName("LegourmetFarming_01_23")
	elseif self.typeOfSeed == "Corn" or self.typeOfSeed == "Sugarcane" or self.typeOfSeed == "Sunflower" or self.typeOfSeed == "Tobacco" then
		self:setSpriteName("vegetation_farming_01_4")
	elseif self.typeOfSeed == "Bean" then
		self:setSpriteName("LegourmetFarming_02_35")
	elseif self.typeOfSeed == "BellPepper" then
		self:setSpriteName("LegourmetFarming_02_32")
	elseif self.typeOfSeed == "Eggplant" then
		self:setSpriteName("LegourmetFarming_02_39")
	elseif self.typeOfSeed == "Grape" then
		self:setSpriteName("LegourmetFarming_02_36")
	elseif self.typeOfSeed == "Pea" then
		self:setSpriteName("LegourmetFarming_02_32")
	elseif self.typeOfSeed == "Rice" then
		self:setSpriteName("LegourmetFarming_02_51")
	elseif self.typeOfSeed == "Lemon" then
		self:setSpriteName("LegourmetFarming_03_49")
	elseif self.typeOfSeed == "Orange" or self.typeOfSeed == "GrapeFruit" then
		self:setSpriteName("LegourmetFarming_03_51")
	elseif self.typeOfSeed == "Apple" or self.typeOfSeed == "Peach" or self.typeOfSeed == "Pear" or self.typeOfSeed == "Mango" then
		self:setSpriteName("LegourmetFarming_03_53")
	elseif self.typeOfSeed == "Banana" then
		self:setSpriteName("LegourmetFarming_03_55")
	elseif self.typeOfSeed == "Cherry" or self.typeOfSeed == "Lime" then
		self:setSpriteName("LegourmetFarming_03_56")
	elseif self.typeOfSeed == "Pineapple" then
		self:setSpriteName("LegourmetFarming_03_58")
	elseif self.typeOfSeed == "Avocado" then
		self:setSpriteName("LegourmetFarming_03_76")
	elseif self.typeOfSeed == "Coffee" then
		self:setSpriteName("LegourmetFarming_02_68")
	elseif self.typeOfSeed == "Wheat" then
		self:setSpriteName("LegourmetFarming_01_72")
	else
...
function SPlantGlobalObject:rottenThis()
	...
	elseif(self.typeOfSeed == "Leek") then
		texture = "LegourmetFarming_02_15"
	elseif(self.typeOfSeed == "Lettuce") then
		texture = "LegourmetFarming_02_23"
	elseif(self.typeOfSeed == "Onion") then
		texture = "LegourmetFarming_02_7"
	elseif(self.typeOfSeed == "Peanut") then
		texture = "LegourmetFarming_02_31"
	...
	elseif(self.typeOfSeed == "Pumpkin") then
		texture = "LegourmetFarming_01_15"
	elseif(self.typeOfSeed == "Watermelon") then
		texture = "LegourmetFarming_01_31"
	elseif(self.typeOfSeed == "Zucchini") then
		texture = "LegourmetFarming_01_23"
	elseif(self.typeOfSeed == "Bean") then
		texture = "LegourmetFarming_01_7"
	elseif(self.typeOfSeed == "BellPepper") then
		texture = "LegourmetFarming_01_47"
	elseif(self.typeOfSeed == "Eggplant") then
		texture = "LegourmetFarming_01_63"
	elseif(self.typeOfSeed == "Grape") then
		texture = "LegourmetFarming_01_55"
	elseif(self.typeOfSeed == "Pea") then
		texture = "LegourmetFarming_01_39"
	elseif(self.typeOfSeed == "Rice") then
		texture = "LegourmetFarming_02_49"
	elseif(self.typeOfSeed == "Corn") then
		texture = "vegetation_farming_01_79"
	elseif(self.typeOfSeed == "Lemon") then
		texture = "LegourmetFarming_03_8"
	elseif(self.typeOfSeed == "Orange") then
		texture = "LegourmetFarming_03_16"
	elseif(self.typeOfSeed == "Apple") then
		texture = "LegourmetFarming_03_24"
	elseif(self.typeOfSeed == "Pear") then
		texture = "LegourmetFarming_04_47"
	elseif(self.typeOfSeed == "Peach") then
		texture = "LegourmetFarming_03_32"
	elseif(self.typeOfSeed == "Banana") then
		texture = "LegourmetFarming_03_40"
	elseif(self.typeOfSeed == "Pineapple") then
		texture = "LegourmetFarming_02_59"
	elseif(self.typeOfSeed == "Cherry") then
		texture = "LegourmetFarming_03_48"
	elseif(self.typeOfSeed == "Lime") then
		texture = "LegourmetFarming_03_67"
	elseif(self.typeOfSeed == "Avocado") then
		texture = "LegourmetFarming_03_75"
	elseif(self.typeOfSeed == "Coffee") then
		texture = "LegourmetFarming_02_67"
	elseif(self.typeOfSeed == "Chili") then
		texture = "LegourmetFarming_02_77"
	elseif(self.typeOfSeed == "Wheat") then
		texture = "LegourmetFarming_01_71"
	elseif(self.typeOfSeed == "Sugarcane") then
		texture = "LegourmetFarming_04_7"
	elseif(self.typeOfSeed == "Sunflower") then
		texture = "LegourmetFarming_04_15"
	elseif(self.typeOfSeed == "Tobacco") then
		texture = "LegourmetFarming_04_23"
	elseif(self.typeOfSeed == "Habanero") then
		texture = "LegourmetFarming_04_31"
	elseif(self.typeOfSeed == "Jalapeno") then
		texture = "LegourmetFarming_04_39"
	elseif(self.typeOfSeed == "Mango") then
		texture = "LegourmetFarming_04_55"
	elseif(self.typeOfSeed == "GrapeFruit") then
		texture = "LegourmetFarming_04_63"
	end
...
function SPlantGlobalObject:destroyThis()
	...
	elseif self.typeOfSeed == "BellPepper" or self.typeOfSeed == "Pea" then
		self:setSpriteName("LegourmetFarming_02_33")
	elseif self.typeOfSeed == "Grape" then
		self:setSpriteName("LegourmetFarming_02_37")
	elseif self.typeOfSeed == "Bean" then
		self:setSpriteName("LegourmetFarming_02_34")
	elseif self.typeOfSeed == "Eggplant" then
		self:setSpriteName("LegourmetFarming_02_38")
	elseif self.typeOfSeed == "Pumpkin" or self.typeOfSeed == "Watermelon" then
		self:setSpriteName("LegourmetFarming_02_41")
	elseif self.typeOfSeed == "Rice" then
		self:setSpriteName("LegourmetFarming_02_50")
	elseif self.typeOfSeed == "Lemon" then
		self:setSpriteName("LegourmetFarming_03_50")
	elseif self.typeOfSeed == "Orange" or self.typeOfSeed == "GrapeFruit" then
		self:setSpriteName("LegourmetFarming_03_52")
	elseif self.typeOfSeed == "Apple" or self.typeOfSeed == "Peach" or self.typeOfSeed == "Pear" or self.typeOfSeed == "Mango" then
		self:setSpriteName("LegourmetFarming_03_54")
	elseif self.typeOfSeed == "Banana" then
		self:setSpriteName("LegourmetFarming_03_55")
	elseif self.typeOfSeed == "Cherry" or self.typeOfSeed == "Lime" then
		self:setSpriteName("LegourmetFarming_03_57")
	elseif self.typeOfSeed == "Pineapple" then
		self:setSpriteName("LegourmetFarming_03_59")
	elseif self.typeOfSeed == "Avocado" then
		self:setSpriteName("LegourmetFarming_03_77")
	elseif self.typeOfSeed == "Coffee" then
		self:setSpriteName("LegourmetFarming_02_69")
	elseif self.typeOfSeed == "Wheat" then
		self:setSpriteName("LegourmetFarming_01_72")
	elseif self.typeOfSeed == "Sugarcane" or self.typeOfSeed == "Sunflower" or self.typeOfSeed == "Tobacco" then
		self:setSpriteName("vegetation_farming_01_4")
	else
