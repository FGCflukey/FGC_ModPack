...
ISDoubleDoorPlus = ISBuildingObject:derive("ISDoubleDoor");

--************************************************************************--
--** ISDoubleDoorPlus:new
--**
--************************************************************************--
function ISDoubleDoorPlus:create(x, y, z, north, sprite)
	...
	local sprite = 'fixtures_doors_fences_01_40';
	...
	if self.north then
		sprite = 'fixtures_doors_fences_01_34';
...
function ISDoubleDoorPlus:addDoorPart(x,y,z,north,sprite,index)
	local cell = getWorld():getCell();
...
function ISDoubleDoorPlus:overrideModData(spriteIndex)
...
function ISDoubleDoorPlus:new(sprite, spriteIndex)
	local o = {};
	setmetatable(o, self);
	self.__index = self;
	o:init();
	o:setSprite'fixtures_doors_fences_01_40';
	o.sprite2 ='fixtures_doors_fences_01_41';
	o.sprite3 = 'fixtures_doors_fences_01_32';
	o.sprite4 = 'fixtures_doors_fences_01_33';
	o.northSprite = 'fixtures_doors_fences_01_34'
	o.northSprite2 = 'fixtures_doors_fences_01_35';
	o.northSprite3 = 'fixtures_doors_fences_01_42';
	o.northSprite4 = 'fixtures_doors_fences_01_43';
	o.isDoor = true;
	o.thumpDmg = 5;
	o.name = "Double Door";
	o.isWallLike = true
...
function ISDoubleDoorPlus:getHealth()
	return 300 + buildUtil.getWoodHealth(self);
end

function ISDoubleDoorPlus:isValid(square)
	...
	-- I added a check for walls between each part in IsoDoor.ISDoubleDoorPlusObstructed().
...
function ISDoubleDoorPlus:render(x, y, z, square)
...
function ISDoubleDoorPlus:getSquare2Pos(square, north)
	local x = square:getX()
	local y = square:getY()
	local z = square:getZ()
	if north then
...
function ISDoubleDoorPlus:getSquare3Pos(square, north)
	local x = square:getX()
	local y = square:getY()
	local z = square:getZ()
	if north then
...
function ISDoubleDoorPlus:getSquare4Pos(square, north)
	local x = square:getX()
	local y = square:getY()
	local z = square:getZ()
	if north then
...
function ISDoubleDoorPlus:partExists(square, index)
	local spriteName
	if self.north then
