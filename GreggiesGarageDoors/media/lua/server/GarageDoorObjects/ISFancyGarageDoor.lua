ISFancyGarageDoor = ISBuildingObject:derive('ISGarageDoor')

function ISFancyGarageDoor:create(x, y, z, north, sprite)
...
function ISFancyGarageDoor:addDoorPart(x, y, z, north, sprite, index)
  local cell = getWorld():getCell()
...
function ISFancyGarageDoor:isValid(square)
...
function ISFancyGarageDoor:render(x, y, z, square)
...
function ISFancyGarageDoor:getSquare2Pos(square, north)
  local x = square:getX()
  local y = square:getY()
  local z = square:getZ()
  if north then
...
function ISFancyGarageDoor:getSquare3Pos(square, north)
  local x = square:getX()
  local y = square:getY()
  local z = square:getZ()
  if north then
...
function ISFancyGarageDoor:partExists(square, index)
  local spriteName
  if self.north then
    if index == 1 then
      spriteName = self.northSprite
...
function ISFancyGarageDoor:new3(sprite, spriteIndex)
  local o = {}
  setmetatable(o, self)
  self.__index = self
  o:init()
  print("index --> " .. spriteIndex)
  print("sprite --> " .. sprite)
  o:setSprite(sprite .. spriteIndex)
  o.sprite2 = sprite .. spriteIndex + 1
  print("sprite2 --> " .. o.sprite2)
  o.sprite3 = sprite .. spriteIndex + 2
  print("sprite3 --> " .. o.sprite3)
  o.northSprite = sprite .. spriteIndex + 3
  print("northSprite --> " .. o.northSprite)
  o.northSprite2 = sprite .. spriteIndex + 4
  print("northSprite2 --> " .. o.northSprite2)
  o.northSprite3 = sprite .. spriteIndex + 5
  print("northSprite3 --> " .. o.northSprite3)
  o.thumpDmg = 5
  o.name = 'Fancy Garage Door'
  return o
end
