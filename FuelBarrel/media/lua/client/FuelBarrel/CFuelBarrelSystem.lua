...
CFuelBarrelSystem = CGlobalObjectSystem:derive("CFuelBarrelSystem")

function CFuelBarrelSystem:new()
	local o = CGlobalObjectSystem.new(self, "fuelbarrel")
	return o
end

function CFuelBarrelSystem:isValidIsoObject(isoObject)
	return instanceof(isoObject, "IsoThumpable") and isoObject:getName() == "FuelBarrel"
end

function CFuelBarrelSystem:newLuaObject(isoObject)
	return CFuelBarrelGlobalObject:new(self, isoObject)
end

CGlobalObjectSystem.RegisterSystemClass(CFuelBarrelSystem)
