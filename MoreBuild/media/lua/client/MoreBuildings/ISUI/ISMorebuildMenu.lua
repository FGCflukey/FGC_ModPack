...
DebugWindow = ISCollapsableWindow:derive("MoreBuild")
...
MoreBuild.textWallPaperDescription = getText("Tooltip_tipwp1")
MoreBuild.textWallPaperPillarDescription = getText("Tooltip_tipwpp1")
MoreBuild.textWallPaperDoorFrameDescription = getText("Tooltip_tipwpdf1")
MoreBuild.textWallPaperWindowFrameDescription = getText("Tooltip_tipwpwf1")
MoreBuild.textGlassWallDescription = getText("Tooltip_tip5b")
MoreBuild.textPillarDescription = getText("Tooltip_tip6")
MoreBuild.textGlassPillarDescription = getText("Tooltip_tipglassPillar")
...
MoreBuild.textDoorSecurity = getText("Tooltip_tip12b")
...
--***********************************************************************--
-- keyword     Holy shit, this is nuts.   here's my 'fix' for now instead of a rewrite  Griz
--***********************************************************************--
...
local function predicateScrewdriver(item)
    ...
    return not item:isBroken() and item:hasTag( "Screwdriver")
end

local function predicateTrowel(item)
...
local function predicateSaw(item)
	
    return not item:isBroken() and item:hasTag( "Saw")
end
...
--*************************************************************************--
--   the containsEvalRecurse() function uses the 'predicate' functions above to evaluate
--   each item in an inventory against a desired match.
--*************************************************************************--	
	
	MoreBuild.toolsList["Hammer"] = _inventory:containsEvalRecurse( predicateHammer)
	MoreBuild.toolsList["Screwdriver"] = _inventory:containsEvalRecurse( predicateScrewdriver)
	MoreBuild.toolsList["Trowel"] = _inventory:containsEvalRecurse( predicateTrowel)
	MoreBuild.toolsList["Saw"] = _inventory:containsEvalRecurse( predicateSaw)
	MoreBuild.toolsList["Shovel"] = _inventory:containsEvalRecurse( predicateShovel)
...
--*********************************************************************
	...
	MoreBuild.toolsText["Trowel"] = getItemText "Trowel"
	MoreBuild.toolsText["Saw"] = getItemText "Saw"
	MoreBuild.toolsText["Shovel"] = getItemText "Shovel"
...
--*************************************************************************************************
-- keyword
--           Turns out this one was easier, just replaced the one line for a better option
--*************************************************************************************************
	...
	local _inventoryList = getSpecificPlayer(player):getInventory():getAllEvalRecurse( buildUtil.predicateMaterial) --this recursively gets only material type items from a players inventory
...
MoreBuild.wallStylesMenuBuilder = function(subMenu, player, context, worldobjects)
	...
	local _styleList =
	{
		...
		getText "ContextMenu_Wall_Papered",
		getText "ContextMenu_GlassWall_Full",
		getText "ContextMenu_GlassWall_Half",
		getText "ContextMenu_GlassWall_Multi",
		getText "ContextMenu_GlassWall_Wood",
		getText "ContextMenu_jailcellbars",
	}
...
-- WALLS
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_48"
	_sprite.northSprite = "walls_interior_house_03_49"
	_sprite.corner = "walls_interior_house_03_51"

	_name = getText "ContextMenu_Wall_Papered_GBStriped"

	_option = subMenu[getText "ContextMenu_Wall_Papered"]:addOption(_name, nil, MoreBuild.onBuildWoodenWall, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.wallObject, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = MoreBuild.textWallPaperDescription .. _tooltip.description
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_01_0"
	_sprite.northSprite = "walls_interior_house_01_1"
	_sprite.corner = "walls_interior_house_01_3"

	_name = getText "ContextMenu_Wall_Papered_WGStriped"
	...
	_sprite = {}
	_sprite.sprite = "location_hospitality_sunstarmotel_01_0"
	_sprite.northSprite = "location_hospitality_sunstarmotel_01_1"
	_sprite.corner = "location_hospitality_sunstarmotel_01_3"

	_name = getText "ContextMenu_Wall_Papered_WPStriped"
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_16"
	_sprite.northSprite = "walls_interior_house_03_17"
	_sprite.corner = "walls_interior_house_03_19"

	_name = getText "ContextMenu_Wall_Papered_WGFlowered"
	...
	_sprite = {}
	_sprite.sprite = "location_hospitality_sunstarmotel_01_4"
	_sprite.northSprite = "location_hospitality_sunstarmotel_01_5"
	_sprite.corner = "location_hospitality_sunstarmotel_01_3"

	_name = getText "ContextMenu_Wall_Papered_WPFlowered"
...
--	GLASS WALLS
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_40"
	_sprite.northSprite = "walls_commercial_01_41"
	_sprite.corner = "walls_commercial_01_39"

	_name = getText "ContextMenu_glass_wall_1"

	_option = subMenu[getText "ContextMenu_GlassWall_Half"]:addOption(_name, nil, MoreBuild.onBuildWoodenWall, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.wallObject, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = MoreBuild.textGlassWallDescription .. _tooltip.description

	_tooltip:setTexture(_sprite.sprite)

	_sprite = {}
	_sprite.sprite = "walls_commercial_02_8"
	_sprite.northSprite = "walls_commercial_02_9"
	_sprite.corner = "walls_commercial_02_11"

	_name = getText "ContextMenu_glass_wall_2"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_02_0"
	_sprite.northSprite = "walls_commercial_02_1"
	_sprite.corner = "walls_commercial_02_3"

	_name = getText "ContextMenu_glass_wall_3"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_16"
	_sprite.northSprite = "walls_commercial_01_17"
	_sprite.corner = "walls_commercial_01_19"

	_name = getText "ContextMenu_glass_wall_4"

	_option = subMenu[getText "ContextMenu_GlassWall_Full"]:addOption(_name, nil, MoreBuild.onBuildWoodenWall, _sprite, player, _name)
	...
	_sprite = {}
	_sprite.sprite = "location_shop_greenes_01_9"
	_sprite.northSprite = "location_shop_greenes_01_8"
	_sprite.corner = "location_shop_greenes_01_12"

	_name = getText "ContextMenu_glass_wall_5"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_0"
	_sprite.northSprite = "walls_commercial_01_1"
	_sprite.corner = "walls_commercial_01_2"

	_name = getText "ContextMenu_glass_wall_6"

	_option = subMenu[getText "ContextMenu_GlassWall_Multi"]:addOption(_name, nil, MoreBuild.onBuildWoodenWall, _sprite, player, _name)
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_32"
	_sprite.northSprite = "walls_commercial_01_33"
	_sprite.corner = "walls_commercial_01_35"

	_name = getText "ContextMenu_glass_wall_7"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_02_51"
	_sprite.northSprite = "walls_commercial_02_48"
	_sprite.corner = "walls_exterior_wooden_02_3"

	_name = getText "ContextMenu_glass_wall_8"

	_option = subMenu[getText "ContextMenu_GlassWall_Wood"]:addOption(_name, nil, MoreBuild.onBuildWoodenWall, _sprite, player, _name)
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_02_52"
	_sprite.northSprite = "walls_commercial_02_49"
	_sprite.corner = "walls_exterior_wooden_02_3"

	_name = getText "ContextMenu_glass_wall_9"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_02_53"
	_sprite.northSprite = "walls_commercial_02_50"
	_sprite.corner = "walls_exterior_wooden_02_3"

	_name = getText "ContextMenu_glass_wall_10"
...
-- CEMENT BRICK JAIL
	...
	_sprite = {}
	_sprite.sprite = "location_community_police_01_0"
	_sprite.northSprite = "location_community_police_01_1"
	_sprite.corner = "location_community_police_01_3"

	_name = getText "ContextMenu_jailcellbarswall"

	_option = subMenu[getText "ContextMenu_jailcellbars"]:addOption(_name, nil, MoreBuild.onBuildStoneWall, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.stoneArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_jailcellbarswall" .. _tooltip.description
...
MoreBuild.pillarsMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_51"
	_sprite.northSprite = "walls_interior_house_03_51"

	_name = getText "ContextMenu_Wall_Papered_Pillar_GB"

	_option = subMenu[getText "ContextMenu_Wall_Papered"]:addOption(_name, nil, MoreBuild.onBuildWoodenPillar, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.wallObject, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = MoreBuild.textWallPaperPillarDescription .. _tooltip.description
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_01_3"
	_sprite.northSprite = "walls_interior_house_01_3"

	_name = getText "ContextMenu_Wall_Papered_Pillar_WG"
	...
	_sprite = {}
	_sprite.sprite = "location_hospitality_sunstarmotel_01_3"
	_sprite.northSprite = "location_hospitality_sunstarmotel_01_3"

	_name = getText "ContextMenu_Wall_Papered_Pillar_WP"
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_19"
	_sprite.northSprite = "walls_interior_house_03_19"

	_name = getText "ContextMenu_Wall_Papered_Pillar_WGF"
	...
	_name = getText "ContextMenu_Wall_Papered_Pillar_WPF"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_39"
	_sprite.northSprite = "walls_commercial_01_39"

	_name = getText "ContextMenu_glass_wall_11"

	_option = subMenu[getText "ContextMenu_GlassWall_Half"]:addOption(_name, nil, MoreBuild.onBuildWoodenPillar, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.wallObject, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = MoreBuild.textGlassPillarDescription .. _tooltip.description

	_tooltip:setTexture(_sprite.sprite)

	_sprite = {}
	_sprite.sprite = "walls_commercial_02_11"
	_sprite.northSprite = "walls_commercial_02_11"

	_name = getText "ContextMenu_glass_wall_12"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_02_3"
	_sprite.northSprite = "walls_commercial_02_3"

	_name = getText "ContextMenu_glass_wall_13"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_19"
	_sprite.northSprite = "walls_commercial_01_19"

	_name = getText "ContextMenu_glass_wall_14"

	_option = subMenu[getText "ContextMenu_GlassWall_Full"]:addOption(_name, nil, MoreBuild.onBuildWoodenPillar, _sprite, player, _name)
	...
	_sprite = {}
	_sprite.sprite = "location_shop_greenes_01_12"
	_sprite.northSprite = "location_shop_greenes_01_12"

	_name = getText "ContextMenu_glass_wall_15"
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_2"
	_sprite.northSprite = "walls_commercial_01_2"

	_name = getText "ContextMenu_glass_wall_16"

	_option = subMenu[getText "ContextMenu_GlassWall_Multi"]:addOption(_name, nil, MoreBuild.onBuildWoodenPillar, _sprite, player, _name)
	...
	_sprite = {}
	_sprite.sprite = "walls_commercial_01_35"
	_sprite.northSprite = "walls_commercial_01_35"

	_name = getText "ContextMenu_glass_wall_17"
	...
	_sprite = {}
	_sprite.sprite = "location_community_police_01_3"
	_sprite.northSprite = "location_community_police_01_3"

	_name = getText "ContextMenu_cellsteelpillar"

	_option = subMenu[getText "ContextMenu_jailcellbars"]:addOption(_name, nil, MoreBuild.onBuildStonePillar, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.stoneArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_cellsteelpillar" .. _tooltip.description
...
MoreBuild.onBuildWoodenPillar = function(ignoreThisArgument, sprite, player, name)
	...
	_pillar.canBePlastered = MoreBuild.playerCanPlaster
...
MoreBuild.onBuildStonePillar = function(ignoreThisArgument, sprite, player, name)
	...
	_pillar.modData["need:Base.Plank"] = "3"
	_pillar.modData["need:Base.Nails"] = "4"
	_pillar.modData["xp:Woodwork"] = "5"
...
MoreBuild.doorFramesMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_58"
	_sprite.northSprite = "walls_interior_house_03_59"
	_sprite.corner = "walls_interior_house_03_51"

	_name = getText "ContextMenu_Wall_Papered_DoorFrame_GBStriped"

	_option = subMenu[getText "ContextMenu_Wall_Papered"]:addOption(_name, nil, MoreBuild.onBuildWoodenDoorFrame, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.wallObject, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = MoreBuild.textWallPaperDoorFrameDescription .. _tooltip.description
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_01_10"
	_sprite.northSprite = "walls_interior_house_01_11"
	_sprite.corner = "walls_interior_house_01_3"

	_name = getText "ContextMenu_Wall_Papered_DoorFrame_WGStriped"
	...
	_sprite = {}
	_sprite.sprite = "location_hospitality_sunstarmotel_01_10"
	_sprite.northSprite = "location_hospitality_sunstarmotel_01_11"
	_sprite.corner = "location_hospitality_sunstarmotel_01_3"

	_name = getText "ContextMenu_Wall_Papered_DoorFrame_WPStriped"
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_26"
	_sprite.northSprite = "walls_interior_house_03_27"
	_sprite.corner = "walls_interior_house_03_19"

	_name = getText "ContextMenu_Wall_Papered_DoorFrame_WGFlowered"
	...
	_sprite = {}
	_sprite.sprite = "location_hospitality_sunstarmotel_01_14"
	_sprite.northSprite = "location_hospitality_sunstarmotel_01_15"
	_sprite.corner = "location_hospitality_sunstarmotel_01_3"

	_name = getText "ContextMenu_Wall_Papered_DoorFrame_WPFlowered"
	...
	_sprite = {}
	_sprite.sprite = "location_community_police_01_10"
	_sprite.northSprite = "location_community_police_01_11"
	_sprite.corner = "location_community_police_01_3"

	_name = getText "ContextMenu_jailcelldoorframe"

	_option = subMenu[getText "ContextMenu_jailcellbars"]:addOption(_name, nil, MoreBuild.onBuildStoneDoorFrame, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.stoneArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_jailcellbardoorframe" .. _tooltip.description
...
MoreBuild.onBuildStoneDoorFrame = function(ignoreThisArgument, sprite, player, name)
	...
	_doorFrame.modData["need:Base.Plank"] = "5"
	_doorFrame.modData["need:Base.Nails"] = "6"
	_doorFrame.modData["xp:Woodwork"] = "5"
...
MoreBuild.windowFramesMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_56"
	_sprite.northSprite = "walls_interior_house_03_57"
	_sprite.corner = "walls_interior_house_03_51"

	_name = getText "ContextMenu_Wall_Papered_WindowFrame_GBStriped"

	_option = subMenu[getText "ContextMenu_Wall_Papered"]:addOption(_name, nil, MoreBuild.onBuildWoodenWindowFrame, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.wallObject, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = MoreBuild.textWallPaperWindowFrameDescription .. _tooltip.description
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_01_8"
	_sprite.northSprite = "walls_interior_house_01_9"
	_sprite.corner = "walls_interior_house_01_3"

	_name = getText "ContextMenu_Wall_Papered_WindowFrame_WGStriped"
	...
	_sprite = {}
	_sprite.sprite = "location_hospitality_sunstarmotel_01_8"
	_sprite.northSprite = "location_hospitality_sunstarmotel_01_9"
	_sprite.corner = "location_hospitality_sunstarmotel_01_3"

	_name = getText "ContextMenu_Wall_Papered_WindowFrame_WPStriped"
	...
	_sprite = {}
	_sprite.sprite = "walls_interior_house_03_24"
	_sprite.northSprite = "walls_interior_house_03_25"
	_sprite.corner = "walls_interior_house_03_19"

	_name = getText "ContextMenu_Wall_Papered_WindowFrame_WGFlowered"
	...
	_sprite = {}
	_sprite.sprite = "location_hospitality_sunstarmotel_01_12"
	_sprite.northSprite = "location_hospitality_sunstarmotel_01_13"
	_sprite.corner = "location_hospitality_sunstarmotel_01_3"

	_name = getText "ContextMenu_Wall_Papered_WindowFrame_WPFlowered"
...
MoreBuild.onBuildStoneWindowFrame = function(ignoreThisArgument, sprite, player, name)
	...
	_windowFrame.modData["need:Base.Plank"] = "5"
	_windowFrame.modData["need:Base.Nails"] = "6"
	_windowFrame.modData["xp:Woodwork"] = "5"
...
MoreBuild.fencesMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "test_02_3"
	_sprite.northSprite = "test_02_4"
	_sprite.corner = "test_02_5"
	...
	_sprite = {}
	_sprite.sprite = "test_02_0"
	_sprite.northSprite = "test_02_1"
	_sprite.corner = "test_02_2"
	...
	_sprite = {}
	_sprite.sprite = "test_02_8"
	_sprite.northSprite = "test_02_9"
	_sprite.corner = "test_02_10"
...
MoreBuild.onBuildGenerator = function(ignoreThisArgument, sprite, player, name)
	...
	_Generator.modData["need:Base.MetalPipe"] = "4"
...
MoreBuild.onBuildStove = function(ignoreThisArgument, sprite, player, name)
	...
	_stove.modData["need:Base.MetalPipe"] = "4"
	_stove.modData["need:Base.SheetMetal"] = "4"
...
MoreBuild.onBuildFireplace = function(ignoreThisArgument, sprite, player, name)
	local _fireplace = ISFireplace:new(sprite.sprite, sprite.sprite, getSpecificPlayer(player))
	
	_fireplace.needToBeAgainstWall = true
	_fireplace.blockAllTheSquare = false
	_fireplace.renderFloorHelper = true
	_fireplace.canPassThrough = true
	_fireplace.canBarricade = false
	_fireplace.canBeAlwaysPlaced = true
	
	_fireplace.player = player
	_fireplace.name = name

	_fireplace:setSprite('fixtures_fireplaces_01_5')
	_fireplace:setNorthSprite('fixtures_fireplaces_01_0')

	_fireplace.modData["need:Base.MetalPipe"] = "4"
	_fireplace.modData["need:Base.SheetMetal"] = "4"
	_fireplace.modData["need:Base.Nails"] = "20"
	_fireplace.modData["need:Base.Screws"] = "10"
...
MoreBuild.onBuildStoneFence = function(ignoreThisArgument, sprite, player, name)
	...
	_fence.modData["need:Base.Plank"] = "3"
	_fence.modData["need:Base.Nails"] = "4"
	_fence.modData["xp:Woodwork"] = "5"
...
MoreBuild.onBuildStoneFencePost = function(ignoreThisArgument, sprite, player, name)
	...
	_fencePost.modData["need:Base.Nails"] = "3"
	_fencePost.modData["xp:Woodwork"] = "5"
...
MoreBuild.doorsMenuBuilder = function(subMenu, player, context, worldobjects)
	...
	local _securityDoorsOption = subMenu:addOption(getText "ContextMenu_security", worldobjects, nil)
	local _securityDoorsSubMenu = subMenu:getNew(subMenu)

	context:addSubMenu(_securityDoorsOption, _securityDoorsSubMenu)
	MoreBuild.securityDoorsMenuBuilder(_securityDoorsSubMenu, player)
...
MoreBuild.woodenDoorsMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "fixtures_doors_02_4"
	_sprite.northSprite = "fixtures_doors_02_5"
	_sprite.openSprite = "fixtures_doors_02_6"
	_sprite.openNorthSprite = "fixtures_doors_02_7"

	_name = getText "ContextMenu_onewindowbrownwooddoor"
	...
	_sprite = {}
	_sprite.sprite = "fixtures_doors_01_44"
	_sprite.northSprite = "fixtures_doors_01_45"
	_sprite.openSprite = "fixtures_doors_01_46"
	_sprite.openNorthSprite = "fixtures_doors_01_47"

	_name = getText "ContextMenu_onewindowwhitewooddoor"
...
MoreBuild.exteriorDoorsMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "fixtures_doors_01_48"
	_sprite.northSprite = "fixtures_doors_01_49"
	_sprite.openSprite = "fixtures_doors_01_50"
	_sprite.openNorthSprite = "fixtures_doors_01_51"

	_name = getText "ContextMenu_dblglasssteeldoor"
	...
	_sprite = {}
	_sprite.sprite = "location_shop_fossoil_01_60"
	_sprite.northSprite = "location_shop_fossoil_01_61"
	_sprite.openSprite = "location_shop_fossoil_01_62"
	_sprite.openNorthSprite = "location_shop_fossoil_01_63"

	_name = getText "ContextMenu_bluedblglasssteeldoor"
	...
	_sprite = {}
	_sprite.sprite = "location_shop_gas2go_01_60"
	_sprite.northSprite = "location_shop_gas2go_01_61"
	_sprite.openSprite = "location_shop_gas2go_01_62"
	_sprite.openNorthSprite = "location_shop_gas2go_01_63"

	_name = getText "ContextMenu_reddblglasssteeldoor"
	...
	_sprite = {}
	_sprite.sprite = "fixtures_doors_01_20"
	_sprite.northSprite = "fixtures_doors_01_21"
	_sprite.openSprite = "fixtures_doors_01_22"
	_sprite.openNorthSprite = "fixtures_doors_01_23"

	_name = getText "ContextMenu_onewindowmetaldoor"
	...
	_sprite = {}
	_sprite.sprite = "fixtures_doors_01_16"
	_sprite.northSprite = "fixtures_doors_01_17"
	_sprite.openSprite = "fixtures_doors_01_18"
	_sprite.openNorthSprite = "fixtures_doors_01_19"

	_name = getText "ContextMenu_onewindoworangemetaldoor"
...
MoreBuild.securityDoorsMenuBuilder = function(subMenu, player)
	local _sprite
	local _option
	local _tooltip
	local _name = ""
	...
	_name = getText "ContextMenu_policesteeldoor"

	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildWoodenDoor, _sprite, player, _name)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.doorObject, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = MoreBuild.textDoorSecurity .. _tooltip.description
	_tooltip:setTexture(_sprite.sprite)
	
	_sprite = {}
	_sprite.sprite = "location_community_police_01_4"
	_sprite.northSprite = "location_community_police_01_5"
	_sprite.openSprite = "location_community_police_01_6"
	_sprite.openNorthSprite = "location_community_police_01_7"

	_name = getText "ContextMenu_cellmetaldoor"
...
MoreBuild.lowDoorsMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "test_02_16"
	_sprite.northSprite = "test_02_17"
	_sprite.corner = ""
...
MoreBuild.moreFencesMenuBuilder = function(subMenu, player)
	...
	_sprite = {}
	_sprite.sprite = "fencing_01_66"
	_sprite.northSprite = "fencing_01_65"
	_sprite.corner = "fencing_01_69"

	_name = getText "ContextMenu_BlackMetalFence"

	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildMetalFence, _sprite, player)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.metalArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_BlackMetalFence" .. _tooltip.description
	_tooltip:setTexture(_sprite.sprite)

	_sprite = {}
	_sprite.sprite = "fencing_01_50"
	_sprite.northSprite = "fencing_01_49"
	_sprite.corner = "fencing_01_53"

	_name = getText "ContextMenu_SecurityFence1"

	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildMetalFence, _sprite, player)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.metalArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_SecurityFence1" .. _tooltip.description
	_tooltip:setTexture(_sprite.sprite)

	_sprite = {}
	_sprite.sprite = "fencing_01_51"
	_sprite.northSprite = "fencing_01_48"
	_sprite.corner = "fencing_01_52"

	_name = getText "ContextMenu_SecurityFence2"

	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildMetalFence, _sprite, player)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.metalArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_SecurityFence2" .. _tooltip.description
	_tooltip:setTexture(_sprite.sprite)

	_sprite = {}
	_sprite.sprite = "test_02_11"
	_sprite.northSprite = "test_02_12"
	_sprite.corner = "test_02_13"
...
MoreBuild.moreFencePostsMenuBuilder = function(subMenu, player)
	...
	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildMetalFencePost, _sprite, player)
	...
	_sprite = {}
	_sprite.sprite = "fencing_01_69"
	_sprite.northSprite = "fencing_01_69"

	_name = getText "ContextMenu_BlackMetalFencePost"

	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildMetalFencePost, _sprite, player)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.metalArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_BlackMetalFencePost" .. _tooltip.description
	_tooltip:setTexture(_sprite.sprite)

	_sprite = {}
	_sprite.sprite = "fencing_01_53"
	_sprite.northSprite = "fencing_01_53"

	_name = getText "ContextMenu_SecurityFencePost1"

	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildMetalFencePost, _sprite, player)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.metalArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_SecurityFencePost1" .. _tooltip.description
	_tooltip:setTexture(_sprite.sprite)

	_sprite = {}
	_sprite.sprite = "fencing_01_52"
	_sprite.northSprite = "fencing_01_52"

	_name = getText "ContextMenu_SecurityFencePost2"

	_option = subMenu:addOption(_name, nil, MoreBuild.onBuildMetalFencePost, _sprite, player)

	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.metalArchitecture, MoreBuild.ElectricityskillLevel.none, _option, player)
	_tooltip:setName(_name)
	_tooltip.description = getText "Tooltip_SecurityFencePost2" .. _tooltip.description
	_tooltip:setTexture(_sprite.sprite)
...
MoreBuild.getFloorsData = function()
	local _floorData =
	{
		...
		[getText "ContextMenu_qita"] =
		{
			...
			{ "test_02_6", "test_02_6", getText "ContextMenu_ditan88", false },
...
MoreBuild.getCardboardBoxesData = function()
	cardboardBoxes =
	{
		{ "trashcontainers_01_24", "trashcontainers_01_25", getText "ContextMenu_Small_Cardboard_Box", "smallbox", getText "Tooltip_xiaozhixiangtip", }, --尿纸箱
...
function DebugWindow:ButtonClick(button)
	...
	elseif button.internal == "clear_moolds" then
		...
		body:setTemperature(30.0)
		body:setOverallBodyHealth(100.0)
		body:setInfectionLevel(0.0)
		body:setFakeInfectionLevel(0.0)
		body:setBoredomLevel(0.0)
		body:setWetness(0.0)
		body:setCatchACold(0.0)
		body:setHasACold(false)
		body:setColdStrength(0.0)
		body:setSneezeCoughActive(0)
		body:setSneezeCoughTime(0)
		body:setUnhappynessLevel(0.0)
	...
	elseif button.internal == "add_skill" then
		...
		player:LevelPerk(Perks.BluntMaintenance)
		player:LevelPerk(Perks.BluntGuard)
		player:LevelPerk(Perks.BluntParent)
		player:LevelPerk(Perks.BladeMaintenance)
		player:LevelPerk(Perks.BladeGuard)
		player:LevelPerk(Perks.BladeParent)
		player:LevelPerk(Perks.Electricity)
		player:LevelPerk(Perks.MetalWelding)
	...
	elseif button.internal == "add_item" then
		local container = getPlayer():getInventory()
	...
	if button.internal == "Zombie_Spawn" then
		spawnHorde(PlayerX - ZombRand(50), PlayerY + ZombRand(50), PlayerX - ZombRand(50), PlayerY + ZombRand(50), PlayerZ, Zombie)
	end
end

function DebugWindow:createChildren()
	ISCollapsableWindow.createChildren(self)
	local butt = ISButton:new(8, 24, 64, 24, "Open Zombie Manage", butt, DebugWindow.ButtonClick)
	butt.internal = "MG_zombie"
	self:addChild(butt)
	butt = ISButton:new(80, 24, 64, 24, "Clear All Debuff", butt, DebugWindow.ButtonClick)
	butt.internal = "clear_moolds"
	self:addChild(butt)
	butt = ISButton:new(190, 24, 80, 24, "Clear Zombie", butt, DebugWindow.ButtonClick)
