...
function ISUILuaWindow:initialise()
	...
	self.exportButton = ISButton:new(self:getWidth() - 51, 94, 51, 80, "Export", self, function() ISUILuaWindow.portLua("export", true) end); 
	...
	self.importButton = ISButton:new(self:getWidth() - 51, 173, 51, 78, "Import", self, function() ISUILuaWindow.portLua("import", true) end); 
