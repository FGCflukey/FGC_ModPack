...
-- Water Well --
	...
	_sprite = {};
	_sprite.sprite = "test_02_18";
	_sprite.northSprite = "test_02_18";
	_sprite.corner = "test_02_18";
...
-- Generator --
		...
		MoreBuild.neededMaterials =
	{
		...
		{
			Material = "MetalPipe", Amount = 4, Text = getItemText("Metal Pipe"),
		},
...
-- Stove --
	...
	_name = getText "ContextMenu_WoodStove";
	...
	_sprite = {};
	_sprite.sprite = "fixtures_fireplaces_01_5";
	_sprite.northSprite = "fixtures_fireplaces_01_0";
	...
	_tooltip = MoreBuild.canBuildObject(7, 0, _option, player);
	_tooltip:setName(_name);
	_tooltip.description = getText("Tooltip_Fireplace") .. _tooltip.description .. MoreBuild.textCanRotate;
	_tooltip:setTexture(_sprite.sprite);
