...
local noise = function(msg)
	if (ISWaterWell.wantNoise) then print('Water Well: '..msg) end
end
...
function ISWaterWell:isValid(square)
    ...
    for i = 1, square:getObjects():size() do
        ...
        if obj:getTextureName() and getPlayer():getZ() == 0 and (luautils.stringStarts(obj:getTextureName(), "floors_exterior_natural") or
